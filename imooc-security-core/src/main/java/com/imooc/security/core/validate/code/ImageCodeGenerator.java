...
public class ImageCodeGenerator implements ValidateCodeGenerator {
    ...
    public ImageCode createCode(ServletWebRequest request) {
        ...
        String sRand = "";
        for (int i = 0; i < ServletRequestUtils.getIntParameter(request.getRequest(),
                "length",
                securityProperties.getCode().getImage().getLength()); i++) {
        ...
        return new ImageCode(image, sRand, ServletRequestUtils.getIntParameter(request.getRequest(),
                "expireIn",
